...
<head>
	<title>Video Deleted Page Responsive Widget Template :: Aditya Reddy</title>
	<!-- Meta tag Keywords -->
...
<body>
	<div class="video-w3l" data-vide-bg="video/1">
		...
		<h1>
			...
			<span>P</span>age</h1>
		<!-- //title -->
		<a href="index.html"style="color: white;">Login</a>
		<!-- content-->
		<div class="sub-main-w3">
		<form action="imageprocess.jsp" method="post" enctype="multipart/form-data">
        <div class="form-style-agile">
			
                       <input type="file" name="file" size="50" style="color: white" />
<br />
<input type="submit" value="Upload File" />
		...
		<!-- copyright -->
		<div class="footer">
			<p>&copy; 2018 Video Deleted Page. All rights reserved | Design by
